...
const Shorcut = () => {
    return (
        <div>
            <div>
      <div className="flex flex-col gap-2 col-span-1  min-h-screen">
              ...
              <ul className=" pb-4 space-y-1 text-sm">
                <li className="rounded-sm">
                  ...
                  >
                    ...
                    <span className="text-md font-semibold">Web Programming</span>
                  </a>
                </li>
                <li className="rounded-sm">
                  <a
                  ...
                  >
                    ...
                    <span className="text-md font-semibold">Graphics design</span>
                  </a>
                </li>
                <li className="rounded-sm">
                  <a
                ...
                <li className="rounded-sm">
                  <a
                    ...
                    className="flex items-center p-2 space-x-3 rounded-md"
                  >
                    <IoIosArrowDown className="text-2xl bg-slate-200 rounded-full p-1" />
                    <span>See more</span>
                  </a>
                </li>
              </ul>
        ...
        <div className="divider w-2/3 ps-3"></div>
      </div>
    </div>
        </div>
    );
